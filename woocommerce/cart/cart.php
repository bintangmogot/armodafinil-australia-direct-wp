                            ...
                            <div class="flex gap-4 bg-white border border-ink-200 rounded-2xl p-4 woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                                ...
                                <div class="flex-1 min-w-0 flex flex-col justify-center">
                                    ...
                                    <div class="mt-3 flex items-center justify-between gap-3 flex-wrap">
                                            ...
                                            if ( $_product->is_sold_individually() ) {
                                                ...
                                                $product_quantity = woocommerce_quantity_input(
                                                    array(
                                                        ...
                                                        'classes'      => 'w-16 h-9 px-2 text-center border border-ink-200 rounded-full text-sm font-semibold outline-none focus:border-brand-600',
                                                    ),
                                                    $_product,
                                                    false
                                                );
                                        ...
                                        <div class="text-ink-500 hover:text-red-600 transition-colors">
                                            <?php
                                            echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                                'woocommerce_cart_item_remove_link',
                                                sprintf(
                                                    '<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/></svg></a>',
