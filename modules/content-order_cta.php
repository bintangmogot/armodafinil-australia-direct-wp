<?php
/**
 * Order CTA Module Template
 * 
 * Data provided by ACF Sub Fields: tag, title, desc
 */

$tag = get_sub_field('tag') ?: 'Get started';
$title = get_sub_field('title') ?: 'Ready to order with confidence?';
$desc = get_sub_field('desc') ?: 'Pick your pack size, complete a secure checkout in minutes, and track your discreet parcel anywhere in Australia.';
?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 bg-white border border-ink-200 rounded-2xl p-8 md:p-10 relative overflow-hidden">
                ...
                <div class="relative">
                    <span class="text-xs uppercase tracking-widest font-semibold text-brand-700"><?php echo esc_html($tag); ?></span>
                    <h2 class="mt-2 font-serif text-3xl md:text-4xl font-semibold text-ink-900"><?php echo esc_html($title); ?></h2>
                    <p class="mt-3 text-ink-700 max-w-xl"><?php echo esc_html($desc); ?></p>
            ...
            <div class="bg-ink-900 text-white rounded-2xl p-8 md:p-10 relative overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <a href="mailto:support@armodafinil-australia-direct.com" class="mt-5 inline-flex items-center gap-2 h-10 px-5 rounded-full bg-white text-ink-900 text-sm font-semibold hover:bg-brand-100 transition-colors">
