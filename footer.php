		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
			<div class="col-span-2 lg:col-span-2">
				...
				<div class="mt-5 flex items-center gap-3 text-brand-300">
					...
					<a href="#" aria-label="Instagram" class="w-9 h-9 grid place-items-center rounded-full bg-white/5 hover:bg-white/10">
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-instagram"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
					</a>
					<a href="#" aria-label="Twitter" class="w-9 h-9 grid place-items-center rounded-full bg-white/5 hover:bg-white/10">
			...
			<div>
				...
				<ul class="space-y-2 text-sm text-ink-100/80">
					<li><a href="/shop" class="hover:text-brand-300">All products</a></li>
			...
			<div>
				...
				<ul class="space-y-2 text-sm text-ink-100/80">
					...
					<li><a href="#" class="hover:text-brand-300">WhatsApp support</a></li>
				</ul>
			</div>
		</div>
		...
		<div class="border-t border-white/10">
			<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row gap-3 items-start md:items-center justify-between text-xs text-ink-100/60">
				<div class="flex flex-wrap items-center gap-4">
					...
					<span class="inline-flex items-center gap-1.5"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-brand-300"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> SSL secured</span>
