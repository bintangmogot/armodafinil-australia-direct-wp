            ...
            <div class="snap-start shrink-0 w-full sm:w-[350px] bg-white border border-slate-200 rounded-[20px] p-6 shadow-sm flex flex-col">
                ...
                <div class="flex items-center justify-between mt-auto border-t border-slate-100 pt-4">
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 shrink-0 rounded-full bg-indigo-600 text-white flex items-center justify-center font-bold text-[11px] uppercase tracking-wider">
            ...
            <form id="product-review-form" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div>
                        ...
                        <input type="text" name="reviewer_name" required placeholder="John D." class="w-full bg-white border border-slate-200 text-sm rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-slate-400">
                    </div>
                    <div>
                        <label class="block text-[11px] font-bold text-slate-700 uppercase tracking-wider mb-2">Email</label>
                        <input type="email" name="reviewer_email" required placeholder="john@example.com" class="w-full bg-white border border-slate-200 text-sm rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-slate-400">
                    </div>
                    <div>
                        <label class="block text-[11px] font-bold text-slate-700 uppercase tracking-wider mb-2">Title</label>
                        <input type="text" name="review_title" required placeholder="Great product!" class="w-full bg-white border border-slate-200 text-sm rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-slate-400">
                    </div>
                </div>

                <div>
                    <label class="block text-[11px] font-bold text-slate-700 uppercase tracking-wider mb-2">Your Review</label>
                    <textarea name="review_content" required rows="4" placeholder="Share your experience..." class="w-full bg-white border border-slate-200 text-sm rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-slate-400 resize-none"></textarea>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
                    ...
                    <div class="flex flex-col items-end w-full sm:w-auto">
                        <button type="submit" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-sm px-8 py-3.5 rounded-lg transition-colors focus:ring-4 focus:ring-indigo-600/20">
